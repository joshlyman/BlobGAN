...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--dataroot', default='./datasets/Syn3DBlobs', help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
        parser.add_argument('--blob_type', type=str, default='noisy_blob', help='noisy_blob,human_glom,mouse_glom')
