...
class ResnetGenerator(nn.Module):
    ...
    def __init__(self, input_nc, output_nc, ngf=32, norm_layer=nn.BatchNorm3d, use_dropout=False, n_blocks=6, padding_type='replicate'):
        ...
        model = [
                 ...
                 # nn.Conv3d(input_nc, ngf, kernel_size=3, padding=0, bias=use_bias),
                 norm_layer(ngf),
                 nn.ReLU(True)]
        ...
        # model += [nn.Conv3d(ngf, output_nc, kernel_size=3, padding=0)]
        model += [nn.Tanh()]
...
class UnetGenerator(nn.Module):
    ...
    def __init__(self, input_nc, output_nc, num_downs, ngf=32, norm_layer=nn.BatchNorm3d, use_dropout=False):
